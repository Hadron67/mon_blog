...
[返回目录](#目录)
## 胞－胞关系
{% asset_img cell-cell.png 胞与胞的位置关系 %}
...
### 二面平行
{% asset_img plane-plane1.png 二面关系 %}
...
{% asset_img plane-plane2.png 最大角与最小角示意图 %}
...
{% asset_img plane-plane3.png 投影法 %}
#### 2-形式法
...
#### 几何法与射影面积定理
记得高中做立体几何时非常喜欢几何法，就算题目给的是坐标都还是想用几何法，总有些看不起向量法。四维空间里面也有相应的几何法，下面我们通过一个例子来了解一下它。
{% asset_img plane-plane4.png 几何法例题 %}
